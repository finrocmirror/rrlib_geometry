 ...
 */
//----------------------------------------------------------------------
#ifndef _rrlib_geometry_tBezierCurve_h_
#define _rrlib_geometry_tBezierCurve_h_
...
public:
  ...
  tBezierCurve(const std::vector<typename tShape::tPoint> &control_points);
...
private:
  ...
  tBezierCurve(const typename tShape::tPoint * const control_points);
...
#include "rrlib/geometry/tBezierCurve.hpp"
